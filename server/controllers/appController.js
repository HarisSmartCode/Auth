...
export async function register(req, res) {
    ...
    try {
        ...
        const existEmail = new Promise((resolve, reject) => {
            let checkEmail = UserModel.findOne({ email })
            if (!checkEmail) reject(new Error(err))
            if (!checkEmail) reject({ error: "Please use unique Email" });
